...
// 好像tinylfu没有办法考虑时间
void _simulation_tinylfu(string trace_file, string cache_type, uint64_t cache_size,
 ...
 + to_string(cache_size);
    ...
    std::cout<<"no_warmup_byte_miss_ratio:"<<
    ...
    std::cout<<"no_warmup_object_miss_ratio:"<<
    ...
    // }));
    std::cout<<"segment_byte_miss:"<<std::endl;
    for(const auto &element: seg_byte_miss){
        std::cout<<element<<",";
    }
    cout<<endl;
    ...
    //         child.append(element);
    // }));
    std::cout<<"segment_byte_req:"<<std::endl;
    for(const auto &element: seg_byte_req){
        std::cout<<element<<",";
    }
    cout<<endl;
    ...
    //         child.append(element);
    // }));
    std::cout<<"segment_object_miss:"<<std::endl;
    for(const auto &element: seg_object_miss){
        std::cout<<element<<",";
    }
    cout<<endl;
    ...
    //         child.append(element);
    // }));
    std::cout<<"segment_object_req:"<<std::endl;
    for(const auto &element: seg_object_req){
        std::cout<<element<<",";
    }
    cout<<endl;
